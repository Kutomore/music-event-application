...
ActiveRecord::Schema.define(version: 20_200_501_165_201) do
  ...
  create_table 'event_artists', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[event_id playing_order], name: 'by_playing_order_and_event', unique: true
  ...
  create_table 'genres_profiles', id: false, force: :cascade do |t|
    ...
    t.uuid 'genre_id', null: false
    t.index %w[profile_id genre_id], name: 'index_genres_profiles_on_profile_id_and_genre_id'
  end
